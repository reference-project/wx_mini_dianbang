      ...
      success: function (res) {
        ...
        demo.reverseGeocoder({
          ...
          success: function (res) {
            ...
            wx.navigateTo({
              url: "/pages/user/member/application?address=" + that.data.address + "&province=" + res.result.address_component.province + "&city=" + res.result.address_component.city + "&area=" + res.result.address_component.district + "&street=" + res.result.address_component.street_number
            });
            console.log(res);
